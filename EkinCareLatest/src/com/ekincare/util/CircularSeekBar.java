...
/**
 * Created by rakeshk on 25-03-2015.
 */
/*
 *
...
public class CircularSeekBar extends View {
    ...
    private static final float DEFAULT_CIRCLE_STROKE_WIDTH = 8f;
...
//    private static final int DEFAULT_CIRCLE_COLOR = Color.parseColor("#9e9595");
    private static final int DEFAULT_CIRCLE_COLOR = Color.parseColor("#DFDFDF");
//    private static final int DEFAULT_CIRCLE_COLOR = R.color.transparent_light_bg;

//    private static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.parseColor("#428BCA");
    private static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.parseColor("#2196f3");
