...
/**
 * Created by rakeshk on 10-01-2015.
 */
 ...
 */
    ...
    private final static int ANTON = 16;
    private final static int GOUTHAM_ROUNDED=17;
    private final static int GOUTHAM_ROUNDED_BOLD=18;
    private final static int GOUTHAM_ROUNDED_BOLD_ITALIC=19;
    private final static int GOUTHAM_ROUNDED_ITALIC =20;
    private final static int GOUTHAM_ROUNDED_LIGHT =21;
    private final static int GOUTHAM_ROUNDED_LIGHT_ITALIC =22;
    private final static int GOUTHAM_ROUNDED_MEDIUM =23;
    private final static int GOUTHAM_ROUNDED_MEDIUM_ITALIC =24;
    private final static int LIBERATIONMONO_REGULAR =25;
    /**
    ...
    private Typeface createTypeface(Context context, int typefaceValue) throws IllegalArgumentException {
        ...
        switch (typefaceValue) {
            ...
            case ANTON:
                typeface = Typeface.createFromAsset(context.getAssets(), "fonts/Roboto-Regular.ttf");
                break;
            case GOUTHAM_ROUNDED:
                typeface = Typeface.createFromAsset(context.getAssets(), "fonts/Roboto-Regular.ttf");
                break;
            case GOUTHAM_ROUNDED_BOLD:
                typeface = Typeface.createFromAsset(context.getAssets(), "fonts/Roboto-Regular.ttf");
                break;
            case GOUTHAM_ROUNDED_BOLD_ITALIC:
                typeface = Typeface.createFromAsset(context.getAssets(), "fonts/Roboto-Regular.ttf");
                break;
            case GOUTHAM_ROUNDED_ITALIC:
                typeface = Typeface.createFromAsset(context.getAssets(), "fonts/Roboto-Regular.ttf");
                break;
            case GOUTHAM_ROUNDED_LIGHT:
                typeface = Typeface.createFromAsset(context.getAssets(), "fonts/Roboto-Regular.ttf");
                break;
            case GOUTHAM_ROUNDED_LIGHT_ITALIC:
                typeface = Typeface.createFromAsset(context.getAssets(), "fonts/Roboto-Regular.ttf");
                break;
            case GOUTHAM_ROUNDED_MEDIUM:
                typeface = Typeface.createFromAsset(context.getAssets(), "fonts/Roboto-Regular.ttf");
                break;
            case GOUTHAM_ROUNDED_MEDIUM_ITALIC:
                typeface = Typeface.createFromAsset(context.getAssets(), "fonts/Roboto-Light.ttf");
                break;
            case LIBERATIONMONO_REGULAR:
                typeface = Typeface.createFromAsset(context.getAssets(), "fonts/Roboto-Light.ttf");
                break;
            default:
