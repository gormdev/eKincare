...
public class DialogWaistPicker extends DialogFragment {
    private Context context;
    private WheelView secondWheelView;
    ArrayList<String> list;
    DialogWaistInterface dialogWaistInterface;
    FloatingActionButton wheelWeight;
    int weelWaistScrollPosition;
    String weelWaistScrollvalue;

    @Override
    public void onAttach(Activity activity) {
        super.onAttach(activity);
        dialogWaistInterface = (DialogWaistInterface) activity;

    }

    @SuppressLint("ValidFragment")
    public DialogWaistPicker(Context context, ArrayList<String> list) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        secondWheelView.setOnWheelItemSelectedListener(new WheelView.OnWheelItemSelectedListener() {
            ...
            public void onItemSelected(int position, Object o) {
                weelWaistScrollPosition = position;
                weelWaistScrollvalue = o.toString();
                dialogWaistInterface.setWaist(o.toString(), position);
            }
        });
        ...
        wheelWeight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialogWaistInterface.setWaist(weelWaistScrollvalue, weelWaistScrollPosition);
                dismiss();
            }
        });
