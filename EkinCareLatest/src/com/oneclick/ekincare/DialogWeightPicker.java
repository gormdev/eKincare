...
public class DialogWeightPicker extends DialogFragment
{
	private Context context;
	private WheelView secondWheelView;
	private ArrayList<String> list;
	private DialogWeightInterface dialogWeightInterface;
	private FloatingActionButton wheelWeight;
	private int weelWeightScrollPosition;
	private String weelWeightScrollvalue;

	@Override
	public void onAttach(Activity activity) {
		super.onAttach(activity);
		dialogWeightInterface = (DialogWeightInterface) activity;

	}
	
	@SuppressLint("ValidFragment")
	public DialogWeightPicker(Context context, ArrayList<String> list)
	{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		wheelWeight.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				dialogWeightInterface.setWeight(weelWeightScrollvalue,weelWeightScrollPosition);
				dismiss();
			}
		});
